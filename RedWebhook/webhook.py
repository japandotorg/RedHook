...
class RedHook:
    ...
    def __init__(self, url=None, content=None, username=None, avatar_url=None, **kwargs):
        """
        init Webhook for Discord and Red-Bot
        -----------
        ...
        self.profile = kwargs.get("proxies")
...
class DiscordEmbed:
    ...
    def __init__(self, title=None, description=None, hex_color='808080', **kwargs):
        """
        Init Discord Embed
        -----------
